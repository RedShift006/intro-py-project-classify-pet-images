...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Using CNN is: " + model.upper())
    ...
    for key in results_stats_dic:
        ...
        #
        if key[0] == 'p':
          print(key + " percentage is: " + str(results_stats_dic[key]))
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if sum(results_dic[key][3:] == 1):
                print("Img Label is: " + key + "Classified label is: " + results_dic[key][1])
    else:
        print("Classifier is correct!")
    if (print_incorrect_breed and 
        (results_stats_dic['n_dogs_img'] != results_stats_dic['n_breed_correct_dogs']) 
       ):
        ...
        print("All breed is classfied right!")
